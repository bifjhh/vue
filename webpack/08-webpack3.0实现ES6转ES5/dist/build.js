...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__static_css_site_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__static_css_site_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__static_css_site_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__calc_js__ = __webpack_require__(8);
// 1.0 获取dom对象
...
// 使用es6语法导入 
 //不返回函数对象的直接在import 后面写 路径
 //返回的对象的，需要设置接受的名称，另外不能写在某一函数的内部，必须写在顶级（全局）
bt.onclick = function () {
    ...
    res.value = __WEBPACK_IMPORTED_MODULE_1__calc_js__["a" /* default */].add(v1value, v2value);
}
